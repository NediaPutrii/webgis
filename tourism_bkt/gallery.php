                        ...
                        <div class="panel-body">
                            ...
                            <div style="margin:15px; display:flex; justify-content:center">
                              ...
                              <?php
                                  ...
                                  while($baris = pg_fetch_assoc($hasil)){
                                    if(($baris['gallery_tourism']=='-')||($baris['gallery_tourism']=='')){
                                      echo "<a href='../_foto/foto.jpg'><img src='../_foto/foto.jpg' ></a><br>";
                                    }
                                    else{
                                      echo "<a href='../_foto/".$baris['gallery_tourism']."'><img src='../_foto/".$baris['gallery_tourism']."'></a>";
                                    }
                  ...
                  <div class="col-sm-12"> <!-- peta -->
                    <div class="white-panel pns">
                              ...
                              <header class="panel-heading" style="float:left">
                                ...
                                <a class="btn btn-success" role="button" data-toggle="collapse" onclick="posisisekarang()" title="Current Position" style="margin-right:10px"   ><i class="fa fa-map-marker" style="color:white;"></i></a>
                              </header>
                              <div class="row">
