<div class="col-sm-12">  <!-- menampilkan fasilitas-->
    <section class="panel">
        <div class="panel-body">
            <a href="?page=fasilitas_add" class="btn btn-compose" title="Add Facility" style="background-color:black"><i class="fa fa-plus" ></i>Facility</a>
            <div class="box-body">
                <div class="form-group">
                    <table id="example3" class="table table-hover table-bordered table-striped">
                        ...
                        <tbody>
                        <?php
                            $sql = pg_query("SELECT * FROM facility_tourism order by id ASC");
