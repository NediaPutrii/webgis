	        ...
	        <div class="panel-body">
				<table>
					<tbody  style='vertical-align:top;'>
						...
						<tr><td><a href="?page=formsetF&id=<?php echo $id ?>" class="btn btn-round btn-success"><i class="fa fa-edit"></i> Set Facility</a></td></tr></tr>
						<tr><td><br></td></tr>
					</tbody>					
				</table>
				...
				<div class='collapse' id='info'>
		     	 ...
		     	 <?php 
                    ...
                    ?>
                    <table class="table">
                    	<thead><th>Date</th><th class="centered">Info</th><th>Action</th></thead>
                    <?php  
                      while ($rows = pg_fetch_array($result)) 
                        {
                          ...
                          echo "<tr><td>$tgl</td><td>$info</td><td><a href='act/info_delete.php?id_informasi=$id_info&id=$id' class='btn btn-sm btn-default' title='Delete'><i class='fa fa-trash-o'></i></a></td></tr>";
                        }
